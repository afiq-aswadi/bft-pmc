...
| `beta_bernoulli_main_figure`, `grid_beta_bernoulli` (2) | `balls_and_urns/beta_bernoulli.py` (trains + plots; saves `model.pt` + `pmc_samples.npz`) | seed-0 run at the settings in the paper's Beta-Bernoulli appendix | `paper_data/beta_bernoulli/` (100k-step run, M3 job 58335652, 2026-07-16; `posterior_single.png` -> `beta_bernoulli_main_figure.png`, `posterior_grid.png` -> `grid_beta_bernoulli.png`) |
